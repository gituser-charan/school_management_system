    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mothers_mobile_no', models.BigIntegerField(null=True, unique=True, validators=[django.core.validators.MaxValueValidator(9999999999), django.core.validators.MinValueValidator(1000000000)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alternate_mobile_no', models.BigIntegerField(null=True, unique=True, validators=[django.core.validators.MaxValueValidator(9999999999), django.core.validators.MinValueValidator(1000000000)])),
                ('gender', models.CharField(choices=[('Male', 'MALE'), ('Female', 'FEMALE'), ('others', 'not specified')], max_length=10)),
                ('date_of_birth', models.DateField()),
                ('date_of_joining', models.DateField(null=True)),
                ('subject_details', models.IntegerField(null=True)),
